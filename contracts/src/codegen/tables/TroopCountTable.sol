...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("TroopCountTable")));
bytes32 constant TroopCountTableTableId = _tableId;

library TroopCountTable {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("TroopCountTable", _fieldNames);
  }
  ...
  /** Get value */
  function get(int32 x, int32 y) internal view returns (uint32 value) {
  ...
  function get(IStore _store, int32 x, int32 y) internal view returns (uint32 value) {
    bytes32[] memory _primaryKeys = new bytes32[](2);
    _primaryKeys[0] = bytes32(uint256(uint32((x))));
    _primaryKeys[1] = bytes32(uint256(uint32((y))));
  ...
  /** Set value */
  function set(int32 x, int32 y, uint32 value) internal {
    bytes32[] memory _primaryKeys = new bytes32[](2);
    _primaryKeys[0] = bytes32(uint256(uint32((x))));
    _primaryKeys[1] = bytes32(uint256(uint32((y))));
  ...
  function set(IStore _store, int32 x, int32 y, uint32 value) internal {
    bytes32[] memory _primaryKeys = new bytes32[](2);
    _primaryKeys[0] = bytes32(uint256(uint32((x))));
    _primaryKeys[1] = bytes32(uint256(uint32((y))));
