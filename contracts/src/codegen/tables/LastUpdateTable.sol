...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("LastUpdateTable")));
bytes32 constant LastUpdateTableTableId = _tableId;

library LastUpdateTable {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("LastUpdateTable", _fieldNames);
  }
  ...
  /** Get value */
  function get(int32 x, int32 y) internal view returns (uint256 value) {
  ...
  function get(IStore _store, int32 x, int32 y) internal view returns (uint256 value) {
    bytes32[] memory _primaryKeys = new bytes32[](2);
    _primaryKeys[0] = bytes32(uint256(uint32((x))));
    _primaryKeys[1] = bytes32(uint256(uint32((y))));
  ...
  /** Set value */
  function set(int32 x, int32 y, uint256 value) internal {
    bytes32[] memory _primaryKeys = new bytes32[](2);
    _primaryKeys[0] = bytes32(uint256(uint32((x))));
    _primaryKeys[1] = bytes32(uint256(uint32((y))));
  ...
  function set(IStore _store, int32 x, int32 y, uint256 value) internal {
    bytes32[] memory _primaryKeys = new bytes32[](2);
    _primaryKeys[0] = bytes32(uint256(uint32((x))));
    _primaryKeys[1] = bytes32(uint256(uint32((y))));
