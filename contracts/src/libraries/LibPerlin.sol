...
library LibPerlin {
    function noise2d(
        ...
        h.r = lerp(
            ...
            lerp(
                h.u,
                grad2d(int16(p(h.AA)), h.x, h.y),
                grad2d(int16(p(h.BA)), dec(h.x), h.y)
            ),
            lerp(
                h.u,
                grad2d(int16(p(h.AB)), h.x, dec(h.y)),
                grad2d(int16(p(h.BB)), dec(h.x), dec(h.y))
            )
        );
    ...
    function noise(
        ...
        h.r = lerp(
            ...
            lerp(
                ...
                lerp(
                    h.u,
                    grad(i0(h.pAA), h.x, h.y, h.z),
                    grad(i0(h.pBA), dec(h.x), h.y, h.z)
                ),
                lerp(
                    h.u,
                    grad(i0(h.pAB), h.x, dec(h.y), h.z),
                    grad(i0(h.pBB), dec(h.x), dec(h.y), h.z)
                )
            ),
            lerp(
                h.v,
                lerp(
                    h.u,
                    grad(i1(h.pAA), h.x, h.y, dec(h.z)),
                    grad(i1(h.pBA), dec(h.x), h.y, dec(h.z))
                ),
                lerp(
                    h.u,
                    grad(i1(h.pAB), h.x, dec(h.y), dec(h.z)),
                    grad(i1(h.pBB), dec(h.x), dec(h.y), dec(h.z))
                )
            )
        );
            ...
            Math.mul(
                ...
                Math.mul(
                    ...
                    Math.mul(
                        ...
                        (
                            Math.add(
                                Math.mul(t, (Math.sub(Math.mul(t, _6), _15))),
                                _10
                            )
                        )
                    )
